<?php
	...
	echo "				
					...
					<td colspan='2'>
									<b>Data Proclamacao:</b><br> 
									<select style='font-size: 30px; background-color: rgb(230,230,230);' name='dia_proclamacao'>";
							for($i=1; $i<=31; $i++){
								echo"
									  <option value='$i'>$i</option>
									";
							...
							echo"		</select> 
									/<select style='font-size: 30px; background-color: rgb(230,230,230);' name='mes_proclamacao'>
									  <option value='01'>01</option>
									  <option value='02'>02</option>
									  <option value='03'>03</option>
									  <option value='04'>04</option>
									...
									<select style='font-size: 30px; background-color: rgb(230,230,230);' name='ano_proclamacao'>";	
							for($i=1900; $i<= date('Y'); $i++){
								echo"
									  <option value='$i'>$i</option>
									";
