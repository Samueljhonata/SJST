...
<a id="texto"> <?php 
 ...
 echo "<div><br> <a  id='botao' style='background-color: rgb(50,50,50);'>Novo Mensalista</a>>>>> <br><br><br>";
 ?>
 <form method="post" action="cad_mensalista.php">
 Nome: <input type="text" name="nome" /><br><br>
 Telefone: <input type="text" name="tel" /><br><br>
 Permição para: <input type="text" placeholder="Nome" name="perm1" />, 
  <input type="text" name="perm2" placeholder="Nome" /><br>
  &nbsp <input type="text" name="perm3" placeholder="Nome" /> , 
  <input type="text" name="perm4" placeholder="Nome" /> , 
  <input type="text" name="perm5" placeholder="Nome" /><br><br>
 Débito: R$<input type="text" style="width: 200px;" name="debito" placeholder="Valor já devido" value="0.00" /> &nbsp &nbsp
 <input type="submit" id="botao" value="Cadastrar" style="background-color: green;"/>
 <br><br>

 </form>
 <?php if (isset($_SESSION['mensalista'])){
$mensalista= $_SESSION['mensalista'];
 echo "Cadastrado com sucesso: $mensalista";}
...
$result = $db->query('SELECT * FROM clientes', PDO::FETCH_ASSOC);
