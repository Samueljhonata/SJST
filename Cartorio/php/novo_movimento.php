...
$numRows = $db->exec("INSERT INTO `cartorio`.`caixa` (`id`, `semelhanca`, `autenticidade`, `autenticacao`, `a_eletronica`, `cartao`, `usuario`, `data`) VALUES ('', '$seme' , '$auten', '$autenticacao', 'a_eletronica', '$cartao', '$usuario', '$data')");
}
