...
var f_rec_firma = document.getElementById("rec_firma").value;
...
var f_total = ((parseInt(f_rec_firma) + parseInt(f_autenticacao))*5.27)+(parseInt(f_eletronica)*16.33)+(parseInt(f_cartao)*12);
...
<br>
<!-- AQUI -->
<form method="post" action="novo_movimento2.php" id="formulario" style="padding: 10px; position: relative;  left: 150px;" >
<a style="font-size: 40px; background-color: rgb(80,250,80);"> <b>&nbsp &nbsp Caixa &nbsp &nbsp &nbsp &nbsp</b> </a><br>
<table style="padding: 10px; position: relative;  left: 15px;"><tr><td>Rec. Firma:</td> <td><input type="number" id="rec_firma" name="rec_firma" value="0" onClick="calculaCaixa()" onBlur="calculaCaixa()" style="font-size: 30pt; width:100px; " /></td>

<td>Autenticação:</td> <td><input type="number" id="autenticacao" name="autenticacao" value="0" style="font-size: 30pt; width:100px; " onClick="calculaCaixa()" onBlur="calculaCaixa()" /></td>
<tr><td>A.Eletrônica:</td> <td><input type="number" id="a_eletronica" name="a_eletronica" value="0" style="font-size: 30pt; width:100px; " onClick="calculaCaixa()" onBlur="calculaCaixa()" /></td>
<td>Cartão:</td> <td><input type="number" id="cartao"  name="cartao" value="0" style="font-size: 30pt; width:100px; " onClick="calculaCaixa()" onBlur="calculaCaixa()" /></td></tr></table>
