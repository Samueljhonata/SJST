...
<a href="acre.php?id=9&tipo_ed=4&tipo_ed=7&ex=1"> Faz parte </a> ou <a href="acre.php?id=9&tipo_ed=4&tipo_ed=7"> Não faz parte </a>
	...
	<div align="left" style="border:none;">
		...
		<?php 
			if(isset($_GET['ex'])){
				...
				echo"<a href='?b=2' class='menuCima' style='color: red;'> Tentar Invadir </a>";
			}
		?>
	</div>
