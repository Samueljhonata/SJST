...
?>
		<h2 class="titulo2">Tribunal Regional de Justiça de <?php echo $nome_privincia; ?></h2>
		<div style="background-image:url(imagens/portas.png); background-repeat: no-repeat;background-position: center top;" class="divPrincipal center-block text-center">
				...
				<a class="sala" style="position: relative; left: 80px;top:50px; width:30%;">
					Gabinete do Juiz-Mor
				</a>
				<a class="sala" style="position: relative; left: 80px;top:100px; width:30%;">
					 Prisão
				</a>
			</div>
