<?php
   ...
   header("Content-type: image/jpeg"); // define o tipo do arquivo
    ...
    function captcha($largura,$altura,$tamanho_fonte,$quantidade_letras){
        ...
        $fonte = "ARIALN.ttf"; //voce deve ter essa ou outra fonte de sua preferencia em sua pasta
        $preto  = imagecolorallocate($imagem,171,141,81); // define a cor preta
        $branco = imagecolorallocate($imagem,48,33,30); // define a cor branca
